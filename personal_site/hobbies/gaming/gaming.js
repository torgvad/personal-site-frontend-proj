function get_game_text(game) {
	switch (game) {
		...
		case "h3vr": 
			return "Hotdogs, Horseshoes, and Handgrenades is a VR firearm simulation. Every weapon in the game (which there are many with more being added regularly) is realistically simulated in function, appearance, and handling. Different ammunitions do different amounts of damage and have realistic bullet ballistics. This is easily my favorite VR game and has the most amount of hours of any VR game I own.";
		case "zomboid": 
...
function change_video(selected_game) {
	...
	selected_game == "planetside" || selected_game == "h3vr" || selected_game == "zomboid" || selected_game == "rimworld" || selected_game == "minecraft") {
		document.getElementById("game_image").src = selected_game + ".jpg";	
